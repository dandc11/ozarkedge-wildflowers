...
Tell the user the issue number/URL, that the branch (`feature/issue-{NUMBER}-{slug}`) will be created when work on the issue actually starts (see *Creating the Branch* above), and the expected PR title format.
