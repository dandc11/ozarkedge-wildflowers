...
const BloomingNow = (props) => {
    const { bloomingList, className = '' } = props;
    const [currentPlantIndex, setCurrentPlantIndex] = useState(0);
    const [currentPlant, setCurrentPlant] = useState(bloomingList[0]);
    const thisMonth = getCurrentMonthName();

    const changeCurrentPlant = (index) => {
        setCurrentPlant(bloomingList[index]);
    };
    return (
        <section
            id={`bloomingNow`}
        ...
        >
                            ...
                            >
                                ...
                                <div onClick={(e) => changeCurrentPlant(index)}>
                                    <ResponsiveImage
                                        ...
                                        wrapperClassName={`blooming-plant-img relative mb-5 bp-800:w-[5rem]`}
            ...
            <div
                ...
                className={`hidden flex flex-col justify-between gap-5 px-4 bp-800:z-0 bp-800:row-start-2 bp-800:col-start-2 bp-800:col-span-4 bp-800:row-span-5 bp-800:pt-10 bp-800:flex bp-800:order-2 bp-800:rounded-md bp-800:bg-oe-green-yelow-600 bp-1000:ml-48 bp-1000:mt-10 bp-1000:row-start-1 bp-1000:col-start-1 bp-1000:row-span-5 bp-1000:mb-6`}
            ></div>
            <PlantName
            ...
            <Button
                ...
                className={`hidden btn-secondary self-center mt-6 bp-800:block bp-800:z-10 bp-800:mb-8 bp-800:mt-0 bp-800:justify-self-center bp-800:row-start-5 bp-800:col-start-2 bp-800:col-span-4 bp-800:row-span-1 bp-900:mb-14 bp-900:col-end-5 bp-1000:row-start-5 bp-1000:mb-24 bp-1000:self-end`}
            >
                See more
            </Button>
        </section>
