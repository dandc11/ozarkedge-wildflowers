...
description: Guide to the three-tier image architecture (ResponsiveImage, InteractiveImage, never raw Next.js <Image>). Use when adding or editing images in components, GROQ queries, or CSS.
---
